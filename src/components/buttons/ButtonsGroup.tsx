...
export const ButtonsGroup: React.FC<Props> = (props) => {
    const {className, isButton_01, Button_01_ClassName, Button_01_Disable, handleClickButton_01, Button_01_Label,
        Button_02_ClassName, Button_02_Disable, handleClickButton_02, Button_02_Label,
        Button_03_ClassName, Button_03_Disable, handleClickButton_03, Button_03_Label,
        isButton_04, Button_04_ClassName, Button_04_Disable, handleClickButton_04, Button_04_Label} = props;
